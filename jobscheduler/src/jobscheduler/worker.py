...
class Worker:
    def __init__(self, name: str, client: Client, *, job_type="", max_jobs=1):
        ...
        self.wait_times = collections.deque[float](maxlen=50)
        # How long we spend doing a step
        self.step_times = collections.deque[float](maxlen=50)
        # How long we took between steps
        self.between_step_times = collections.deque[float](maxlen=50)
